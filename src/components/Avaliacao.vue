<template>
    ...
    <table v-show="exibirTabela" class="border-collapse border border-slate-500">
...
<button class="mt-6 py-2 px-6 rounded-sm  text-sm
        text-white bg-at-light-green duration-200 border-solid
        border-2 border-transparent hover:border-at-light-green hover:bg-white
        hover:text-at-light-green" @click="exibirTabela = !exibirTabela" v-if="!exibirTabela">Mostrar Tabela IMC
    </button>
    <button class="mt-6 py-2 px-6 rounded-sm  text-sm
        text-white bg-at-light-green duration-200 border-solid
        border-2 border-transparent hover:border-at-light-green hover:bg-white
